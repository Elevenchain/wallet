...
class HelpRpcTest(BitcoinTestFramework):
    ...
    def test_categories(self):
        ...
        # wrong argument count, note: elevenchain's help allows for two options since we utilize subcommands
        ...
        components = ['Addressindex', 'Blockchain', 'Control', 'elevenchain', 'Evo', 'Generating', 'Mining', 'Network', 'Rawtransactions', 'Util']
