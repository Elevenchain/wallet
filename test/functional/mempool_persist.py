...
By default, elevenchaind will dump mempool on shutdown and
...
class MempoolPersistTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent elevenchaind from writing mempool.dat to disk. Verify that `savemempool` fails")
