...
"""Verify that starting elevenchaind with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start elevenchaind with -h for help text")
        ...
        self.log.info("Start elevenchaind with -version for version information")
        ...
        self.log.info("Start elevenchaindd with -fakearg to make sure it does not start")
