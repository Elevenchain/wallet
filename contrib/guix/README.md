# Bootstrappable elevenchain Core Builds

This directory contains the files necessary to perform bootstrappable elevenchain
Core builds.
...
To build elevenchain Core reproducibly with all default options, invoke the
...
2. The `guix-codesign` command ***requires*** a `DETACHED_SIGS_REPO` flag.
    * _**DETACHED_SIGS_REPO**_
      ...
      elevenchain Core version being built.
...
```
env DETACHED_SIGS_REPO=<path/to/elevenchain-detached-sigs> ./contrib/guix/guix-codesign
```
...
repository](https://github.com/elevenchainpay/guix.sigs).
...
[guix-docker]: https://github.com/Elevenchain/tree/master/contrib/guix/Dockerfile
