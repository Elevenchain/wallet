...
EXPECTED_HOLDER_NAMES = [
    ...
    r"The elevenchain Core developers",
    r"BitPay Inc\.",
...
Arguments:
    <base_directory> - The base directory of a elevenchain Core source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The elevenchain Core developers'
...
Arguments:
    <base_directory> - The base directory of elevenchain Core source code repository.
"""
...
Arguments:
    <file> - A source file in the elevenchain Core repository.
"""
