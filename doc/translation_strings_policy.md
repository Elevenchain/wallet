...
This document provides guidelines for internationalization of the elevenchain Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `elevenchain_en.ts` remains unchanged.
