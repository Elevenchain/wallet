# Support for Output Descriptors in elevenchain Core

Since elevenchain Core v0.17, there is support for Output Descriptors. This is a
...
existing elevenchain Core wallets, a convenience function `combo` is
...
All RPCs in elevenchain Core will include the checksum in their output. Only
