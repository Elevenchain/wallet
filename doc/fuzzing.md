# Fuzzing elevenchain Core using libFuzzer

## Quickstart guide

To quickly get started fuzzing elevenchain Core using [libFuzzer](https://llvm.org/docs/LibFuzzer.html):
...
# libFuzzer" on https://github.com/Elevenchain/blob/develop/doc/fuzzing.md#macos-hints-for-libfuzzer
$ make
...
[`process_message`](https://github.com/Elevenchain/blob/develop/src/test/fuzz/process_message.cpp) is a fuzzing harness for the [`ProcessMessage(...)` function (`net_processing`)](https://github.com/Elevenchain/blob/develop/src/net_processing.cpp). The available fuzzing harnesses are found in [`src/test/fuzz/`](https://github.com/Elevenchain/tree/develop/src/test/fuzz).
...
Every single pull request submitted against the elevenchain Core repo is automatically tested against all inputs in the [`bitcoin-core/qa-assets`](https://github.com/bitcoin-core/qa-assets) repo. Contributing new coverage increasing inputs is an easy way to help make elevenchain Core more robust.
...
with certain assembly code from elevenchain Core's code. See [developer notes on sanitizers](https://github.com/Elevenchain/blob/develop/doc/developer-notes.md#sanitizers)
...
# Fuzzing elevenchain Core using afl++

## Quickstart guide

To quickly get started fuzzing elevenchain Core using [afl++](https://github.com/AFLplusplus/AFLplusplus):
...
# Fuzzing elevenchain Core using Honggfuzz

## Quickstart guide

To quickly get started fuzzing elevenchain Core using [Honggfuzz](https://github.com/google/honggfuzz):
