...
This mechanism has been integrated into Bitcore-Node-elevenchain which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/elevenchainpay/insight-api-elevenchain#web-socket-api](https://github.com/elevenchainpay/insight-api-elevenchain#web-socket-api)
* API: [https://github.com/elevenchainpay/insight-api-elevenchain#instantsend-transactions](https://github.com/elevenchainpay/insight-api-elevenchain#instantsend-transactions)
