elevenchain Core version 0.17.0.2
==========================
...
provided in [DIP-0020](https://github.com/elevenchainpay/dips/blob/master/dip-0020.md).
...
from other quorum members. This allows elevenchain Platform to obtain required
...
provided in [DIP-0021](https://github.com/elevenchainpay/dips/blob/master/dip-0021.md).

Platform support
----------------
Support for elevenchain Platform has been expanded through the addition of a new
...
BLS update
----------
elevenchain Core’s BLS signature library has been updated based on v1.0 of the
Chia BLS library to support migration to a new BLS signature scheme which will
be implemented in a future version of elevenchain. These changes will be made to
align with standards and improve security.

Network performance improvements
--------------------------------
This version of elevenchain Core includes multiple optimizations to the network and
p2p message handling code.

We reintroduced [Intra-Quorum Connections](https://github.com/elevenchainpay/dips/blob/master/dip-0006.md#intra-quorum-communication)
...
reliability. Activation of `SPORK_22_PS_MORE_PARTICIPANTS` in elevenchain v0.16
...
Statoshi backport
------------------
This version includes a [backport](https://github.com/Elevenchain/pull/2515)
...
RPC changes
-----------
There are seven new RPC commands which are elevenchain specific and seven new RPC
...
will be removed in elevenchain v0.18. Note that the deprecation of wallet accounts
...
elevenchain users. Bitcoin changes that do not align with elevenchain’s product needs, such
...
See detailed [set of changes](https://github.com/Elevenchain/compare/v0.16.1.1...elevenchainpay:v0.17.0.2).
