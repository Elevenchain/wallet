# elevenchain Core version v19.2.0
...
At the first startup elevenchain Core will run a migration process which can take
...
incompatible with older versions of elevenchain Core, so a db migration path was
...
See detailed [set of changes](https://github.com/Elevenchain/compare/v19.1.0...elevenchainpay:v19.2.0).
