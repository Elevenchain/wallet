 ...
 * database.
 *
 * CBlock(hash=00000ffd590b14, ver=1, hashPrevBlock=00000000000000, hashMerkleRoot=e0028e, nTime=1707329843, nBits=1e0ffff0, nNonce=2145405, vtx=1)
...
{
    const char* pszTimestamp = "X11 is the best algorithm in the world";
...
public:
    CMainParams() {
        ...
        consensus.defaultAssumeValid = uint256S("0x000001ba2e9dd259eb82c96afc6dc92d6421840e5affd3db8639a6cfdd9f1393"); 
        ...
        genesis = CreateGenesisBlock(1707329843, 2145405, 0x1e0ffff0, 1, 11 * COIN);
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x000001ba2e9dd259eb82c96afc6dc92d6421840e5affd3db8639a6cfdd9f1393"));
        assert(genesis.hashMerkleRoot == uint256S("0x170f5418fbc14f304e16e86a2487412aaa6376c15d1d779ddd913e62ed7c1b96"));
        ...
        vSeeds.emplace_back("node.elevenchain.com");
        ...
        // elevenchain BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x88, 0xB2, 0x1E};
        // elevenchain BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x88, 0xAD, 0xE4};

        // elevenchain BIP44 coin type is '5'
        nExtCoinType = 5;
        ...
        vSporkAddresses = {"EcZpe9TTX3sn4HEmEJaRMqDbK9oPrKdhbC"};
        nMinSporkKeys = 1;

        checkpointData = {
            {
                {0, uint256S("0x000001ba2e9dd259eb82c96afc6dc92d6421840e5affd3db8639a6cfdd9f1393")},
            }
        };
        ...
        // getchaintxstats 17280 000001ba2e9dd259eb82c96afc6dc92d6421840e5affd3db8639a6cfdd9f1393
        chainTxData = ChainTxData{
                1707329843, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x000003fe06c6f56a9a38dd945e1a4eb8f9f3b493bf5892a808110c1ec325aa1f"); 
        ...
        genesis = CreateGenesisBlock(1707329848UL, 2528641UL, 0x1e0ffff0, 1, 11 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x000003fe06c6f56a9a38dd945e1a4eb8f9f3b493bf5892a808110c1ec325aa1f"));
        assert(genesis.hashMerkleRoot == uint256S("0x170f5418fbc14f304e16e86a2487412aaa6376c15d1d779ddd913e62ed7c1b96"));
        ...
        // Testnet elevenchain BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Testnet elevenchain BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Testnet elevenchain BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
        ...
        vSporkAddresses = {"CPfJU9Xwkoz82UVTCv1EGoBxdrDYBYFyVA"};
        nMinSporkKeys = 1;

        checkpointData = {
            {
                {0, uint256S("0x000003fe06c6f56a9a38dd945e1a4eb8f9f3b493bf5892a808110c1ec325aa1f")},
            }
        };
        ...
        // getchaintxstats 17280 000003fe06c6f56a9a38dd945e1a4eb8f9f3b493bf5892a808110c1ec325aa1f
        chainTxData = ChainTxData{
                1707329848, // * UNIX timestamp of last known number of transactions
                0,    // * total number of transactions between genesis and that timestamp
                            //   (the tx=... number in the ChainStateFlushed debug.log lines)
                0,       // * estimated number of transactions per second after that timestamp
        };
...
public:
    explicit CDevNetParams(const ArgsManager& args) {
        ...
        genesis = CreateGenesisBlock(1707329853, 0, 0x207fffff, 1, 11 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x6b3bb4e25eeb628847150eec5034268829da0082173da088269498c4e6942009"));
        assert(genesis.hashMerkleRoot == uint256S("0x170f5418fbc14f304e16e86a2487412aaa6376c15d1d779ddd913e62ed7c1b96"));

        devnetGenesis = FindDevNetGenesisBlock(genesis, 11 * COIN);
        ...
        checkpointData = (CCheckpointData) {
            {
                { 0, uint256S("0x6b3bb4e25eeb628847150eec5034268829da0082173da088269498c4e6942009")},
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        // privKey: 6EkZJiEEJf2ECvm7ovx7MUCmGVW4uZpFrD9vb5D7N8mowTdj6d4
        vSporkAddresses = {"CVQY6EwSrpD8qv4E93CA4NjFRRoj1U6qQD"};
        nMinSporkKeys = 1;
        ...
        // Regtest elevenchain addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,28);
        // Regtest elevenchain script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,29);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,156);
        // Regtest elevenchain BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Regtest elevenchain BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Regtest elevenchain BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
