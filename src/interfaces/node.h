...
//! Interface for the src/evo part of a elevenchain node (elevenchaind process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/governance part of a elevenchain node (elevenchaind process).
class GOV
{
public:
    virtual ~GOV() {}
...
//! Interface for the src/llmq part of a elevenchain node (elevenchaind process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a elevenchain node (elevenchaind process).
...
//! Top-level interface for a elevenchain node (elevenchaind process).
class Node
{
public:
    virtual ~Node() {}
