...
/* Initialize elevenchain-specific components after chainstate initialization */
void elevenchainTestSetup(NodeContext& node);
void elevenchainTestSetupClose(NodeContext& node);
