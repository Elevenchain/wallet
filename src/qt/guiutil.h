...
/** Utility functions used by the elevenchain Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "elevenchain:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load elevenchain specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a elevenchain specific theme is activated (light/dark).*/
