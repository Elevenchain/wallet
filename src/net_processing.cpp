 ...
 *  We have 4 times smaller block times in elevenchain, so we need to push 4 times more invs per 1MB. */
...
bool PeerManagerImpl::AlreadyHave(const CInv& inv)
{
    ...
    /*
        elevenchain Related Inventory Messages
...
bool PeerManagerImpl::SendMessages(CNode* pto)
{
...

    {
        ...
        // ECH this code also handles non-TXs (elevenchain specific messages)
